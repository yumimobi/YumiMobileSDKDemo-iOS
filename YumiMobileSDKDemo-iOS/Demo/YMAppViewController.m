...
@implementation YMAppViewController
...
- (IBAction)clickModifyID:(UIButton *)sender {
    ...
    YMViewController *rootVc = [UpgradeHardware instantiateViewControllerWithIdentifier:@"YumiViewController"];
